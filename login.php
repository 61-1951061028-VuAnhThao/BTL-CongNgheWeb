...
<body>
    <div class="wrapper">
        ...
        <div class="text-center mt-4 name"> YouTube </div>
        <form class="p-3 mt-3" action="process-login.php" method = "post">
            <div class="form-field d-flex align-items-center"> <span class="far fa-user"></span> <input type="text"
                    name="txtEmail" id="userName" placeholder="Email"> </div>
            <div class="form-field d-flex align-items-center"> <span class="fas fa-key"></span> <input type="password"
                    name="txtPass" id="pwd" placeholder="Password"> </div> 
            <button class="btn mt-3" name="btnSignIn">Login</button>
        </form>
        <?php
            if(isset($_GET['error'])){
